...
import games.bevs.core.module.abilties.abilities.ThorAbility;
...
public class AbilityModule extends Module
{
	...
	public void onEnable()
	{
		...
		DummyAbilityParent dummy = new DummyAbilityParent(this.getPlugin(), this.getClientModule(), this.getCooldownModule(), this);
...
//		dummy.addAbility(new ThorAbility());
		...
		for(Class<?> abilityClazz : ClassGetterUtils.getClassesForPackage(this.getPlugin(), "games.bevs.core.module.abilties.abilities"))
		{
			try 
			{
